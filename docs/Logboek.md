...
Gerelateerde links:
[Originele mindmaps op papier (links nieuwe, rechts oude)](./Documentatie%20images/Oude%20mindmaps.png)
[Vernieuwde mindmap online gemaakt](./Documentatie%20images/Nieuwe%20mindmap.png)
...
Gerelateerde links:
[Taskflow "The user wants to ask a question"](./Documentatie%20images/Taskflow.png)
[Lo-fi design in Figma](./Documentatie%20images/Wireframe.png)
...
3. Teamwork: Website namechange

Tijdens deze dag heeft Youssef echt laten zien hoeveel hij kan doen op een dag. Hij heeft de userdetails aangemaakt, ze te werken gekregen en zelfs een beetje gestyled. Zo kan een gebruiker nu zijn first/last name veranderen via de website en zijn eigen account verwijderen. Ook zijn er bevestigingen bij het verwijderen zodat je niet per ongeluk je account verwijderd. Dit alles heeft hij gedaan tijdens deze ene dag, met style en logica allemaal functionerend.
Ikzelf had me beziggehouden met het belangrijkste van dit heel project, de vragen. Zo staat er een prachtige button op elke pagina die je kan klikken en naar een nieuwe pagina gaan om een vraag te stellen. De logica hierachter bestaat jammer genoeg niet, maar daar heb ik de hulp van Youssef bij nodig.
